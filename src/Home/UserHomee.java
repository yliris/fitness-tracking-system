...
public class UserHomee extends javax.swing.JFrame {

    private int userId;

    public UserHomee(int userId) {
        this.userId = userId;
        initComponents();
        setBackground(new Color(0, 0, 0, 0));
        mover.initMoving(UserHomee.this);
    ...
    private void initComponents() {
        ...
        profile_btnLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, profile_btnLayout.createSequentialGroup()
                ...
                .addComponent(greetings, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(43, 43, 43))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserHomee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserHomee(userId).setVisible(true);
            }
        });
    }
